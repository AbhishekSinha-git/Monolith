...
exports.processAIQuery = exports.getConnectionStatus = exports.detectAnomalies = exports.projectNetWorth = exports.calculateAffordability = exports.getUnderperformingInvestments = exports.getPortfolioPerformance = exports.getNetWorthHistory = exports.getFinancialData = exports.verifyPasscode = exports.authenticateUser = exports.initializeFiMcp = void 0;
const realFiMcpService_1 = require("../services/realFiMcpService");
// Global Fi MCP service instance
let fiMcpService;
/**
 * Initialize Fi MCP Service
 */
const initializeFiMcp = async (req, res) => {
    try {
        console.log('🚀 Initializing Fi MCP Service...');
        fiMcpService = new realFiMcpService_1.RealFiMcpService();
        await fiMcpService.initialize();
        res.status(200).json({
            success: true,
            message: 'Fi MCP Service initialized successfully',
            status: fiMcpService.getConnectionStatus()
        });
    }
    catch (error) {
...
exports.initializeFiMcp = initializeFiMcp;
/**
...
const authenticateUser = async (req, res) => {
    try {
        ...
        const authResult = await fiMcpService.authenticateUser(phoneNumber);
        res.status(200).json({
            success: true,
            ...authResult
        });
...
const verifyPasscode = async (req, res) => {
    try {
        ...
        const result = await fiMcpService.verifyPasscode(phoneNumber, passcode);
        res.status(200).json({
            success: true,
            ...result
        });
...
const getNetWorthHistory = async (req, res) => {
    try {
        ...
        const history = await fiMcpService.getNetWorthHistory(period);
        res.status(200).json({
            success: true,
            history
        });
 ...
 */
const getUnderperformingInvestments = async (req, res) => {
    try {
        if (!fiMcpService) {
            return res.status(500).json({
                success: false,
...
exports.getUnderperformingInvestments = getUnderperformingInvestments;
/**
 * Calculate loan affordability
 */
const calculateAffordability = async (req, res) => {
    try {
 ...
 * Project net worth
 */
const projectNetWorth = async (req, res) => {
    try {
...
exports.projectNetWorth = projectNetWorth;
/**
